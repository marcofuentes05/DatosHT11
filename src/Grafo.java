...
public interface Grafo <V,E>  {
    ...
    public Arista<V,E> getEdge(V label1, V label2);
    ...
    public boolean visitEdge(Arista<V,E> e);
    ...
    public boolean isVisitedEdge(Arista<V,E> e);
    ...
    public Iterator<Arista<V,E>> edges();
